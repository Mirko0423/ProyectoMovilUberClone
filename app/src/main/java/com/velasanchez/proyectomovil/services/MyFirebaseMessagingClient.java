package com.velasanchez.proyectomovil.services;
...
import com.velasanchez.proyectomovil.activities.driver.NotificationBookingActivity;
import com.velasanchez.proyectomovil.channel.NotificationHelper;
import com.velasanchez.proyectomovil.receivers.AcceptReceiver;
import com.velasanchez.proyectomovil.receivers.CancelReceiver;
...
public class MyFirebaseMessagingClient extends FirebaseMessagingService {
    ...
    //PARA GENERAR UN TOKEN QUE NOS PERMITA ENVIAR NOTIFICACION DE DISPOSITIVO A DISPOSITIVO
    @Override
    public void onNewToken(@NonNull String s) {
        super.onNewToken(s);
    }

    //EN ESTE METODO SE OBTIENEN LAS NOTIFICACIONES PUSH QUE LLEGAN DESDE EL SERVIDOR
    @Override
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (title != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                //PARA SABER SI LA NOTIFICACIÓN ES PARA EL SERVICIO DE UN CLIENTE
                ...
                if (title.contains("SOLICITUD DE SERVICIO")){
                    //AQUI SOLO ESTAMOS OBTENIENDOLAS PERO INICIALMENTE SOLO MANDABAMOS EL ID, DEBEMOS MANDAR TODO LO  DEMAS
                    //ESTO ESTÁ EN EL REQUEST DRIVER ACTIVIYY, SEND NOTIFICATION
                    String idClient = data.get("idClient");
                    String origin = data.get("origin");
                    String destination = data.get("destination");
                    String min = data.get("min");
    ...
    private void showNotificationActivity(String idClient, String origin, String destination, String min, String distance) {
        //ENCIENDA EL CELULAR ASÍ ESTÉ BLOQUEADO
        PowerManager pm = (PowerManager)  getBaseContext().getSystemService(Context.POWER_SERVICE);
       //PARA SABER SI LA PANTALLA ESTÁ PRENDIDA
        ...
        //PARA QUE FUNCIONE EL WAKElOCK SE DEB HABILITAR EL PERMISO EN EL MANIFEST
    }

    //NOTIFICACION PARA VERSIONES INFERIORES
    ...
    private void showNotificationActions(String title, String body, String idClient) {
        ...
        canceltIntent.putExtra("idClient", idClient);
        PendingIntent cancelPendingIntent = PendingIntent.getBroadcast(this, NOTIFICATION_CODE, canceltIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    //NOTIFICACION PARA VERSIONES OREO EN ADELANTE
    @RequiresApi(api = Build.VERSION_CODES.O)
